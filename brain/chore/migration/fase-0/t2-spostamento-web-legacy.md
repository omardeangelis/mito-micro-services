...
| `.env.example` | — |
| `README.md` | spostare in `apps/web-legacy/`; creare un nuovo README root minimale che descrive il monorepo e linka `brain/chore/migration_plan.md` |
...
**Restano alla root:** `brain/`, `.agents/`, `.claude/`, `AGENTS.md`, `CLAUDE.md`, `.github/`, `renovate.json`, `pnpm-lock.yaml` (pnpm lo rigenera in formato workspace al primo install), file creati da F0.T1.
