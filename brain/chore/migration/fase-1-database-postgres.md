...
Ogni task ha un file di dettaglio operativo in `brain/chore/migration/fase-1/`, con frontmatter di stato proprio. T2/T3 possono procedere in parallelo a T1; T4 richiede T1+T3.
