...
> [design-lavorazioni-e-verticali.md](docs/design-lavorazioni-e-verticali.md), che supersede questa sezione, il §2.4, il §6 e la domanda 10 del §7.
...
> la stima aggiornata è **35–43 gg**, in [design-lavorazioni-e-verticali.md §9](docs/design-lavorazioni-e-verticali.md).
...
**Interne (business):**
10. ~~Un cliente può avere lavorazioni prestito e cessione contemporaneamente?~~ → **✅ Sì** (2026-08-04). Vedi [design-lavorazioni-e-verticali.md](docs/design-lavorazioni-e-verticali.md).
